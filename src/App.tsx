...
import { SecureEnclave } from '@/pages/SecureEnclave';
import { AdvancedForensics } from '@/pages/AdvancedForensics';
import { InternationalIntegration } from '@/pages/InternationalIntegration';
...
function AppRoutes() {
  return (
    <Switch>
      ...
      <Route path={"/swarm-control"} component={SwarmControl} />
      ...
      <Route path={"/secure-enclave"} component={SecureEnclave} />
      <Route path={"/advanced-forensics"} component={AdvancedForensics} />
      <Route path={"/international-integration"} component={InternationalIntegration} />
